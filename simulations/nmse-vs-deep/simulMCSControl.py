...
ax.set_xlabel('SNR real do canal', fontsize=11)
ax.set_ylabel('Estimativa de SNR', fontsize=11)
ax.set_xticks(np.arange(0,42,2))
ax.set_yticks(np.arange(-10,42,2))
ax.set_title('Estimativa das métricas com controle de MCS')
ax.legend(['NMSE SNR','REAL SNR','DNN SNR', 'ADAPT SNR'], fontsize=12)
...
plt.savefig('SimulMCSCotnrol_10000samples_50hz_snrstep0.25_range40dB.png', dpi=400)
plt.show()
'''
